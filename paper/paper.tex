...
\section*{Summary}
A common tool to unveil the nature of the scaling and fractionality of a process, natural or computer-generated, is the Detrended Fluctuation Analysis (\texttt{DFA}), initally developed by Peng \textit{et al.} and later extended to study multifractal processes by Kandelhardt \textit{et al.}, giving rise to Multifractal Detrended Fluctuation Analysis (\texttt{MFDFA}) \cite{Peng1994,Kantelhardt2002}.
It addresses the question of the presence of long-range correlations and can be employ to study discrete processes \cite{Hurst1951}, as auto-regressive models, as well as time-continuous stochastic processes.
...
Auto-regressive and stochastic processes diffuse with different rates, and uncovering the rates of diffusion is of importance in natural processes with power-law correlations, like temperature variability \cite{Meyer2019} earthquake frequency \cite{Shadkhoo2009}, and heartbeat dynamics \cite{Ivanov1999}.
