\documentclass[pre, a4paper, aps, floatfix, superscriptaddress, onecolumn, notitlepage]{revtex4-1} %hyperref
...
\todo[inline]{Add references on Earthquake studies, climate, temperature, power-grids(?)}
...
They might by of a mono- or multi-fractal nature.
