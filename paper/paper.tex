...
\section*{Summary}
A common tool to unveil the nature of the scaling and fractionality of a process, natural or computer-generated, is the Detrended Fluctuation Analysis (DFA), initally developed by Peng \textit{et al} and later extended to study multifractal processes by Kandelhardt \textit{et al}, giving rise to Multifractal Detrended Fluctuation Analysis (MFDFA) \cite{Peng1994,Kantelhardt2002}.
...
In order to determine the self-similarity of a stochastic process, one can study the relation between the variance of the process and time.
